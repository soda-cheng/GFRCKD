...
model = dict(
    ...
    use_logit = use_logit,
    is_vit = is_vit,
    teacher_pretrained='configs/pretrain/deit3-small-p16_3rdparty_in1k_20221008-0f7c70cf.pth',
    teacher_cfg = 'configs/deit_cub/deit3_small_cub.py',
    student_cfg = 'configs/deit_cub/deit_tiny_cub.py',
