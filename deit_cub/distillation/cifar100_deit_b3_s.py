_base_ = [
    '../deit_cifar100/deit_small_pre_in1k.py'
]
...
model = dict(
    ...
    use_logit = use_logit,
    is_vit = is_vit,
    teacher_pretrained='configs/pretrain/deit3-base-p16_3rdparty_in1k_20221008-60b8c8bf.pth',
    teacher_cfg = 'configs/deit3_cifar100/deit3_base_pre_in1k.py',
    student_cfg = 'configs/deit_cifar100/deit_small_pre_in1k.py',
