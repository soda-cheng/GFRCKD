_base_ = [
    '../vit_imagenet/vit_small_in1k.py'
]
...
model = dict(
    ...
    use_logit = use_logit,
    is_vit = is_vit,
    teacher_pretrained = 'configs/pretrain/vit-base-p16_pt-32xb128-mae_in1k_20220623-4c544545.pth',
    teacher_cfg = 'configs/vit_imagenet/vit_base_in1k.py',
    student_cfg = 'configs/vit_imagenet/vit_small_in1k.py',
