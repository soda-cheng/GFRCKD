_base_ = [
    '../deit_cifar100/deit_base_pre_in1k.py'
]
...
model = dict(
    ...
    use_logit = use_logit,
    is_vit = is_vit,
    teacher_pretrained='configs/pretrain/deit3-large-p16_3rdparty_in1k_20221009-03b427ea.pth',
    teacher_cfg = 'configs/deit3_cifar100/deit3_large_pre_in1k.py',
    student_cfg = 'configs/deit_cifar100/deit_base_pre_in1k.py',
