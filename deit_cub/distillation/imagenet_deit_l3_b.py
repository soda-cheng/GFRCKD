_base_ = [
    '../deit_imagenet/deit-base_pt-16xb64_in1k.py'
]
...
model = dict(
    ...
    use_logit = use_logit,
    is_vit = is_vit,
    teacher_pretrained = 'configs/pretrain/deit3-large-p16_in21k-pre_3rdparty_in1k_20221009-d8d27084.pth',
    teacher_cfg = 'configs/deit3_imagenet/deit3-large-p16_64xb64_in1k.py',
    student_cfg = 'configs/deit_imagenet/deit-base_pt-16xb64_in1k.py',
